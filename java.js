...
const availableCities = [
  "Москва", "Тюмень", "Курган", "Санкт-Петербург", "Екатеринбург","Казань","Владивосток","Омск",
  ...
  "Тула", "Киров", "Вологда", "Чита", "Пенза", "Брянск", "Архангельск", "Калуга", 
  ...
  "Курск", "Липецк", "Тула", "Киров", "Вологда", "Чита", "Пенза", "Брянск", "Архангельск", 
