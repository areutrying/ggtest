document.addEventListener('DOMContentLoaded', () => {
    ...
    citySelectionMenu.innerHTML = `
        Выберите город
        <input type="text" id="city-input-select" placeholder="Введите город">
        <ul id="city-suggestions-select"></ul>
        <button id="close-city-menu">Отмена</button>
        <button id="confirm-city-btn">Подтвердить</button>
    `;
